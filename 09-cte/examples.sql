...
INSERT INTO #Emp09 VALUES (1,'John',80000,10),(2,'Sara',120000,10),(3,'Mike',45000,20);
CREATE TABLE #Org09 (Id INT, Name VARCHAR(20), ManagerId INT NULL);
INSERT INTO #Org09 VALUES (1,'CEO',NULL),(2,'MgrA',1),(3,'MgrB',1),(4,'Emp1',2),(5,'Emp2',2),(6,'Emp3',3);

-- Basic + chained
WITH EmployeeCTE AS (SELECT Id, Name, Salary FROM #Emp09 WHERE Salary > 50000)
