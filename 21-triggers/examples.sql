...
IF
    OBJECT_ID('dbo.trg_Emp21_Audit', 'TR') IS NOT NULL
    DROP TRIGGER dbo.trg_Emp21_Audit;
IF
    OBJECT_ID('dbo.trg_Emp21_NoCut', 'TR') IS NOT NULL
    DROP TRIGGER dbo.trg_Emp21_NoCut;
...
CREATE TABLE dbo.Audit21 (
    Id INT IDENTITY PRIMARY KEY, Note VARCHAR(200),
