...
INSERT INTO #Emp16 VALUES (1, 'Asha', 10, 90000),
(2, 'Dev', 10, 90000),
(3, 'Ravi', 10, 80000),
...
-- zero rows here; DELETE FROM D WHERE rn > 1 to kill dupes
...
SELECT
    Name,
    Salary,
    NTILE(4) OVER (PARTITION BY DeptId ORDER BY Salary DESC) AS Quart
FROM #Emp16;
