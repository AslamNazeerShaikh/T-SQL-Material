...
CREATE TABLE #City23 (CityId INT PRIMARY KEY, City VARCHAR(30), Pin VARCHAR(10));
...
CREATE TABLE #Phone23 (StaffId INT, Phone VARCHAR(15), PRIMARY KEY (StaffId, Phone));
...
DROP TABLE #Phone23; DROP TABLE #Staff23; DROP TABLE #Team23; DROP TABLE #City23;
