...
INSERT INTO #Staff12 VALUES (1,'Asha',100),(2,'Dev',NULL),(3,'Ravi',200);
...
-- Fill-ins
SELECT Name, COALESCE(Bonus, 0) AS SafeBonus FROM #Staff12;
SELECT Name, ISNULL(Bonus, 0) AS SafeBonus FROM #Staff12;
