...
-- INNER
SELECT e.Name, d.Department FROM #E07 e INNER JOIN #D07 d ON e.DepartmentId = d.Id;
-- LEFT (keeps Mike with NULL)
SELECT e.Name, d.Department FROM #E07 e LEFT JOIN #D07 d ON e.DepartmentId = d.Id;
-- Anti-join: departments with no employees
SELECT d.Department FROM #D07 d LEFT JOIN #E07 e ON e.DepartmentId = d.Id WHERE e.Id IS NULL;
-- RIGHT
SELECT e.Name, d.Department FROM #E07 e RIGHT JOIN #D07 d ON e.DepartmentId = d.Id;
-- FULL OUTER
SELECT e.Name, d.Department FROM #E07 e FULL OUTER JOIN #D07 d ON e.DepartmentId = d.Id;
-- CROSS (3x3=9)
